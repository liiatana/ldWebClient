...
public final class Alias {
    ...
    public static final String INSTRUCTIONS = "mail";
    public static final String DOCS = "assignment";
    public static final String REPORTS = "pie_chart";
    public static final String HISTORY = "watch_later";
