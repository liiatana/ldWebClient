...
public class CreateQuickReportTests extends TestBase {
    Instructions inst;
    ...
    public Object[][] Task() {
        ...
        instr
                ...
                .withText("Сообщение создано для теста отчета без открытия формы отчета") // текст сообщения. Если не задано по умолчанию = текст из типа сообщения. Всегда к тексту добавляется + timestamp
    ...
    public void makeQuickReport(Instruction instruction) {
        ...
        inst.InstructionListWithoutPreview.get(nnum).$$x("/*//div[@class=\"quick-access\"]").get(0).click();
